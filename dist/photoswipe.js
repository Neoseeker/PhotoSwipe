...
var pattern = _options.urlPattern.replace('[gid]', _options.galleryUID).replace('[pid]', '([0-9a-z]+?)');
...
// my hack
if (_options.urlPattern) {
var urlpart = _options.urlPattern.replace('[gid]', _options.galleryUID).replace('[pid]', pid);
